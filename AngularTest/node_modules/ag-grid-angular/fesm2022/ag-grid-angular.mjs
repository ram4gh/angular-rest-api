import { BaseComponentWrapper, _removeFromParent, VanillaFrameworkOverrides, _combineAttributesAndGridOptions, createGrid, _processOnChange } from 'ag-grid-community';
